...
export type TrilhaScalarWhereWithAggregatesInput = {
  ...
  idTrilha?: Prisma.IntWithAggregatesFilter<"Trilha"> | number
  ...
  idCategoria?: Prisma.IntWithAggregatesFilter<"Trilha"> | number
}
...
export type TrilhaOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idTrilha" | "titulo" | "descricao" | "idCategoria", ExtArgs["result"]["trilha"]>
...
export interface TrilhaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const trilhaWithIdTrilhaOnly = await prisma.trilha.findMany({ select: { idTrilha: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Trilhas and only return the `idTrilha`
   * const trilhaWithIdTrilhaOnly = await prisma.trilha.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Trilhas and only return the `idTrilha`
   * const trilhaWithIdTrilhaOnly = await prisma.trilha.updateManyAndReturn({
   *   select: { idTrilha: true },
   *   where: {
   *     // ... provide filter here
   *   },
