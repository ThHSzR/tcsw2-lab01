...
export type MatriculaWhereInput = {
  ...
  idMatricula?: Prisma.IntFilter<"Matricula"> | number
  idUsuario?: Prisma.IntFilter<"Matricula"> | number
  idCurso?: Prisma.IntFilter<"Matricula"> | number
...
export type MatriculaWhereUniqueInput = Prisma.AtLeast<{
  idMatricula?: number
  idUsuario_idCurso?: Prisma.MatriculaIdUsuarioIdCursoCompoundUniqueInput
  AND?: Prisma.MatriculaWhereInput | Prisma.MatriculaWhereInput[]
  OR?: Prisma.MatriculaWhereInput[]
  NOT?: Prisma.MatriculaWhereInput | Prisma.MatriculaWhereInput[]
  idUsuario?: Prisma.IntFilter<"Matricula"> | number
...
export type MatriculaScalarWhereWithAggregatesInput = {
  ...
  idMatricula?: Prisma.IntWithAggregatesFilter<"Matricula"> | number
  idUsuario?: Prisma.IntWithAggregatesFilter<"Matricula"> | number
  idCurso?: Prisma.IntWithAggregatesFilter<"Matricula"> | number
...
export type MatriculaUncheckedUpdateInput = {
  idMatricula?: Prisma.IntFieldUpdateOperationsInput | number
...
export type MatriculaIdUsuarioIdCursoCompoundUniqueInput = {
  idUsuario: number
  idCurso: number
}
...
export type MatriculaOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idMatricula" | "idUsuario" | "idCurso" | "dataMatricula" | "dataConclusao", ExtArgs["result"]["matricula"]>
...
export interface MatriculaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `idMatricula`
   * const matriculaWithIdMatriculaOnly = await prisma.matricula.findMany({ select: { idMatricula: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Matriculas and only return the `idMatricula`
   * const matriculaWithIdMatriculaOnly = await prisma.matricula.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Matriculas and only return the `idMatricula`
   * const matriculaWithIdMatriculaOnly = await prisma.matricula.updateManyAndReturn({
   *   select: { idMatricula: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface MatriculaFieldRefs {
  readonly idMatricula: Prisma.FieldRef<"Matricula", 'Int'>
  readonly idUsuario: Prisma.FieldRef<"Matricula", 'Int'>
  readonly idCurso: Prisma.FieldRef<"Matricula", 'Int'>
